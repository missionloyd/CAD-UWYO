...
# usageZone|UsageZone|equippedWith|DHWFacilities|operationSchedule|TimeSeriesSchedule|RegularTimeSeries|values

# Parse the XML file
tree = ET.parse('output/output.gml')  # Update this with your actual file path
root = tree.getroot()
